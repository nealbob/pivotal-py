...
**Pivotal** is a Python-based Domain-Specific Language (DSL) for data processing. It provides a clean, readable syntax for data frame operations which compiles to Python (pandas) code.
